...
# The same multi-turn protocol also works in real text generation mode.
...
The real multi-turn path now reuses session state across the whole conversation instead of reloading per turn:
